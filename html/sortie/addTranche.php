...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO detailfilaosortie (id_poisson, sac, qtt, typ, id_sortie, qttTranche, dateTranche)
            VALUES (:poisson, :sac, :qtt, :typ, :id_sortie, :qttTranche, :dateTranche)";
    ...
    $stmt->bindParam(':qttTranche', $qtt);
    $stmt->bindParam(':dateTranche', $date);
