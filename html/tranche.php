...
<div class="container"><br>
    <table>
        <tr>
            ...
            <th>
                <a href='sortie/operationTranche.php?date=<?= $_GET['date']?>' class='btn btn-primary'>
                    Operation Tranche
                </a>
            </th>
        </tr>
        ...
        <tbody>
            <?php if (!empty($stocks)): ?>
                <?php foreach ($stocks as $stock): ?>
                    <tr>
                        <form action="sortie/addTranche.php" method="POST">
                            <td>
            ...
            <tbody>
                ...
                foreach ($fetchAll as $fetch) {
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="sortie/delete_poisson.php" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce poisson ?');">
