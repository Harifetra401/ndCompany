...
// Requête SQL pour regrouper les articles par nom_poisson et additionner les poids et autres champs, avec filtre entre deux dates
$sql = "SELECT nom_poisson, SUM(PEnter) AS total_PEnter, SUM(qtt) AS total_qtt, type, SUM(sac) AS total_sac
        FROM testStock
        WHERE EnterDate BETWEEN :start_date AND :end_date
        GROUP BY nom_poisson, type";
$stmt = $db->prepare($sql);
$stmt->execute(['start_date' => $startDate, 'end_date' => $endDate]);
$stocks = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Calculer les totaux pour les poids et les colis
$totalWeight = 0;
$totalColis = 0;
                    ...
                    <div class="container mt-4">
                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="3" class="text-center">Aucun article trouvé pour cette période.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
