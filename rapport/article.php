...
// Sélectionner les lignes de la table `detailfilao` en fonction du mois sélectionné et du numéro de facture
...
<form method="post" action="" class="mb-4">
    ...
    <select name="mois" id="mois" class=" form-control custom-select mr-2">
        <?php for ($m = 1; $m <= 12; $m++): ?>
 ...
 <button onclick="exporterTableauEnCSV('tableau.csv')">Exporter en Exel</button>
