                      ...
                      <div class="card-body">
                        <form id="formAuthentication" class="mb-3" action="add.php" method="POST">
                          <div class="mb-3 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                              <input type="text" id="" class="form-control" name="qtt" placeholder="" require />
                            </div><br>
                            <div class="d-flex justify-content-between">
                              <label class="form-label" for="password">Mise en Carton/sac</label>
                            </div>
                            <div class="input-group input-group-merge">
                            ...
                            <div class="d-flex justify-content-between">
                              <label class="form-label" for="password">Quantite</label>
                            </div>
                            <div class="input-group input-group-merge">
