    ...
    <div class="layout-container">
      ...
      <?php require('../nav/header.php')?>
        <!-- / Navbar -->
          ...
          <form action="../livraison/add_new.php" method="post">
                                ...
                                <div class="mb-3 col">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" class="form-control" name="type" value='SousGlace'><br>
                                            <button class="btn btn-primary d-grid w-100" type="submit">Sous Glace</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
