                    ...
                    <tr>
                        <form action="add.php" method="POST">
                            ...
                            <td>
                                ...
                                <select name='poisson' class='form-control'>
                                       <?php 
                            ...
                            <td>
                                <input type="hidden" class="form-control w-100" name="typ" value='3'>
    ...
    <div class="modal-content">
        ...
        <table>
            ...
            <tbody>
                ...
                $selection->bindParam(':num', $num, PDO::PARAM_INT);
                $selection->execute();
                ...
                foreach ($fetchAll as $fetch) {
                    ...
                    <tr>
                        ...
                        <td><?= $sac_poisson ?></td>
                        <td>
                            <form action="delete_poisson.php" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce poisson ?');">
                                <input type="hidden" name="id_poisson" value="<?= $id ?>">
                                <input type="hidden" name="id_sortie" value="<?= $num ?>">
...
ALTER TABLE `facturesortie` CHANGE `date` `date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
ajouter un filtre par mois de la part de cette table du cilonne date on fonction de id du facture = id_sortie
